...
export default class App extends Component {
 ...
 //  };
  ...
  getWeatherData(searchData) {
    fetch(`http://api.wunderground.com/api/${api.lukeAPI}/conditions/hourly/forecast10day/q/${searchData}.json`)
      .then((response) => response.json())
      .then((weatherData) => {
        this.defineCurrent(weatherData);
        // this.setLocalStorage(weatherData);
